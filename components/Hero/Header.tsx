...
const Header = () => {
  ...
  const content = () => {
    return <div className="absolute flex top-[18%] md:-top-5 flex-col md:justify-center gap-10 md:gap-5 lg:gap-7 lg: w-full h-full items-center text-center">
        <h1 className="text-black-200 md:ml-12 leading-[76px] md:leading-none text-8xl md:text-[55px] lg:text-9xl font-[500] animate-slide-left w-[85%] md:w-[80%]">Build Models You Can Trust</h1>
        ...
        <Button className="bg-gray-300 gap-2 md:gap-3 text-black-700 rounded-3xl px-[20px] py-[23px] font-[500] text-base border-l-1 border-blue-300 border-b-1
